...
from dabi.modules import ALL_MODULES
from dabi.modules.purge import client
from dabi.modules.helper_funcs.chat_status import is_user_admin
from dabi.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("dabi.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                "https://telegra.ph/file/65a5109e77991ff84d665.jpg",
                PM_START_TEXT,
